                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-6 justify-center">
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:rogersalec99@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">
                                        rogersalec99@gmail.com
                                    </a>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+18479245164" className="text-muted-foreground hover:text-primary transition-colors">
                                        +1 (847) 924-5164
                                    </a>
                                </div>
                            </div>
                        ...
                        <div className="pt-8">
                            ...
                            <div className="flex space-x-4 justify-center">
                                <a href="https://www.linkedin.com/in/alec-rogers-b8b934129/" target="_blank">
                                    <Linkedin />
                                </a>
                            </div>
                        </div>
